...
if __name__ == "__main__":
    ...
    video_left = cv2.VideoCapture("../../openVO/distTest/data/videos/rocks_left.avi")
    video_right = cv2.VideoCapture("../../openVO/distTest/data/videos/rocks_right.avi")
    ...
    find_sgbm_settings("../Data/Calibration/competition1/intrinsics_left.p",
                       "../Data/Calibration/competition1/intrinsics_right.p",
                       "../Data/Calibration/competition1/rectParams.p",
